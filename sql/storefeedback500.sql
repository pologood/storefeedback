...
CREATE TABLE `feedback` (
  ...
  KEY `feedback_index_sponsor_id` (`sponsor_id`) USING BTREE,
  KEY `index_feedback_has_return` (`has_return`) USING BTREE,
  KEY `index_feedback_create_time` (`create_time`) USING BTREE,
  KEY `index_feedback_store_code` (`store_code`) USING BTREE,
  KEY `index_feedback_first_category` (`first_category`) USING BTREE,
  KEY `index_feedback_second_category` (`second_category`) USING BTREE,
...
CREATE TABLE `feedback_reciever` (
  ...
  KEY `PK_Feed_Rec_Person` (`feedback_person_id`) USING BTREE,
  KEY `PK_Feed_Rec_Feedback` (`feedback_id`) USING BTREE,
...
CREATE TABLE `feedback_record` (
  ...
  KEY `Index_Feed_Record_person` (`feedback_person_id`) USING BTREE,
  KEY `Index_Feed_Record_Time` (`feedback_time`) USING BTREE,
...
DROP TABLE IF EXISTS `mq_error_info`;
CREATE TABLE `mq_error_info` (
