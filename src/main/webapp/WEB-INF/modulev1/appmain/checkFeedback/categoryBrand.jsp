...
<script type="text/javascript" src="<%=basePath%>modulev2/js/checkFeedback/categoryBrand.js"></script>
</head>
<body>
	<!-- 商品品牌 列表 -->
	...
	<a id="categoryName" style="display:none">${requestScope.categoryName }</a> --%>
	<input id="buyType" value="${requestScope.buyType }" type="hidden">
	<input id="categoryCode" value="${requestScope.categoryCode }" type="hidden">
	<input id="categoryName" value="${requestScope.categoryName }" type="hidden">
