        ...
        $("#sysTree").tree(
                {
                    data : [ {
                        ...
                        id : "sys04",
                        text : "缺断货反馈",
                        url : basePath + "n/navigation/goToFeedbackPage"
                    }, {
                        id : "sys06",
                        text : "消息管理",
                        url : basePath + "n/navigation/goToMessagePage"
                    },
                    {
                        id : "sys07",
                        text : "门店管理",
                        url : basePath + "n/navigation/goToStorePage"
                    }
                    ,
                    {
                        id : "sys08",
                        text : "新品推送配置",
                        url : basePath + "n/navigation/goToGoodsCategoryConfigPage"
                    }
                    ,
                    {
                        id : "sys09",
                        text : "缺断货推送配置",
                        url : basePath + "n/navigation/goToFeedbackPushConfigPage"
                    }
                    ,
                    {
                        id : "sys10",
                        text : "缺断货不补货原因",
                        url : basePath + "n/navigation/goToResultNoReasonPage"
                    },
                    {
                        id : "sys11",
                        text : "缺断货考核配置",
                        url : basePath + "n/navigation/goToFeedbackCheckConfigPage"
                    }
                    ],
